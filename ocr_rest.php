<?php
	...
	*/
        ...
        $url = 'http://www.ocrwebservice.com/restservices/processDocument?gettext=true&outputformat=txt';
        ...
        $filePath = 'https://drive.google.com/uc?export=download&id=1KjsgxnfKMpdDwFrS_nBROBVA2y_AdAHm';
	...
	echo 'AvailablePages:'.$data->AvailablePages."\r\n";
        ...
        file_put_contents('converted_document.txt', $content);
